        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#78004D]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4">
            <a
              ...
              className="bg-white p-2 rounded-full hover:bg-[#78004D] hover:text-white transition-colors"
            >
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Meet our exceptional team of industry experts who bring years of
            experience and dedication to deliver excellence in every project.
          </p>
        </div>
