  ...
  return (
    ...
    >
      <div className="relative max-w-4xl w-full">
        <button
          onClick={onClose}
          className="absolute -top-4 -right-4 w-8 h-8 bg-[#FBEABB] rounded-full flex items-center justify-center shadow-lg hover:bg-[#FBEABB]/90 transition-colors"
        >
          <X className="w-5 h-5 text-[#0E5644]" />
        </button>
        <img
          src={image}
          alt="Modal view"
...
const AboutUs = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#FBEABB]/30">
      <ImageModal
        image={selectedImage}
      ...
      <div className="w-full px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl font-bold text-[#C92127] mb-4">
              About Premier Bakers
            </h1>
            <div className="w-24 h-1 bg-[#C92127] mx-auto mb-8"></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="space-y-6 p-8 bg-white rounded-2xl shadow-lg border border-[#0E5644]/10">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                determination, boundless passion, and distinctive culinary
              ...
              >
                ...
                <div className="text-center p-4 bg-[#0E5644]/5 rounded-lg hover:bg-[#0E5644]/10 transition-colors">
                  <Award className="w-8 h-8 text-[#C44347] mx-auto mb-2" />
                  <p className="font-bold text-2xl text-gray-800">
                    {isVisible && <AnimatedCounter end={1} />}+
                  </p>
                  <p className="text-sm text-gray-600">Awards Won</p>
                </div>
                <div className="text-center p-4 bg-[#0E5644]/5 rounded-lg hover:bg-[#0E5644]/10 transition-colors">
                  <Users className="w-8 h-8 text-[#C44347] mx-auto mb-2" />
                  <p className="font-bold text-2xl text-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-[#0E5644]/5 group border border-[#0E5644]/10">
              <ChefHat className="w-12 h-12 text-[#C44347] mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-bold mb-2 text-[#C44347]">
                Expert Chefs
              </h3>
              <p className="text-gray-600">
                Our master chefs bring years of experience in authentic Arabian
                cuisine.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-[#0E5644]/5 group border border-[#0E5644]/10">
              <Leaf className="w-12 h-12 text-[#C44347] mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-bold mb-2 text-[#C44347]">
                Fresh Ingredients
              </h3>
              <p className="text-gray-600">
                We source only the finest and freshest ingredients for our
                dishes.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-[#0E5644]/5 group border border-[#0E5644]/10">
              <UtensilsCrossed className="w-12 h-12 text-[#C44347] mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-bold mb-2 text-[#C44347]">
                Authentic Taste
              </h3>
              <p className="text-gray-600">
                Experience the true flavors of traditional Arabian cuisine.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-[#0E5644]/5 group border border-[#0E5644]/10">
              <Heart className="w-12 h-12 text-[#C44347] mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-bold mb-2 text-[#C44347]">
                Made with Love
              </h3>
              <p className="text-gray-600">
